...
#formulaErrorPos{
    ...
    <header class="page-header">
        <div class="container-fluid">
            <!--h2 class="no-margin-bottom">Edit User Indicator-->
        </div>
    </header>
    <section class="forms"> 
        <div class="container">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card edit_heading">
                        ...
                        <div class="card-body">
                            ...
                            {{ Form::model($interval, array('route' => array('intervals.update', $interval->id), 'method' => 'PUT')) }}
                                ...
                                <div class="form-group" style="text-align:center;">
                                    ...
                                    {{ Form::submit('Save Indicator!', array('class' => 'save btn btn-primary submit_button')) }}
                                </div>
                            {{ Form::close() }}
                        </div>
                    </div>

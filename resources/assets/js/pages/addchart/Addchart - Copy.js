...
class AddChart extends Component {
    ...
    saveWorkarea() {
      ...
      console.log(charts);
        ...
        axios.post(`/api/workarea/add`, this.state.charts.data)
            .then(response => {
              console.log(response);
                if (response.status === 200) {

                    this.showMessage('success', 'Charts add successfully!');
                }
                this.setState({saving: false});
            })
            .catch(error => {
                this.setState({saving: false});
                this.showMessage('error', 'Unable to add charts.');
            });
    }
            ...
            <div>
                <div className="row">
                    ...
                    <div className="col-sm-3">
                        <p><a className="btn btn-default" onClick={this.renderTypes}>Add</a></p>
                        <div id="charts"></div>

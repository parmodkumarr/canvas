...
#formulaErrorPos{
    ...
    <header class="page-header">
        <div class="container-fluid">
            <h2 class="no-margin-bottom">Edit User Algo
        </div>
    </header>
    <section class="forms"> 
        <div class="container-fluid">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            {{ Form::model($algo, array('route' => array('algos.update', $algo->id), 'method' => 'PUT')) }}
                            <div class="form-group row">
                                   ...
                                   <div class=" col-md-4">
                                    ...
                                    <div>                                 
                                        <label>Type</label>
                                        <div>
                                           <label class="col-md-3"> {{ Form::radio('operator_type', 'buy' , true) }} Buy</label>
                                          <label class="col-md-3">  {{ Form::radio('operator_type', 'sell' , false) }} Sell</label>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group" style="text-align:center;">
                                    <a class="btn btn-default back" href="{{  URL::to('algos') }}">Back</a>
                                    {{ Form::submit('Save algo!', array('class' => 'btn btn-primary save submit_button')) }}
                                </div>
                            {{ Form::close() }}
                        </div>
                    </div>
